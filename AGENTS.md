...
**git-deploy-ng** — Ruby gem, CLI `git deploy`. Push-based deploy over SSH (Thor + net-ssh). Community fork of mislav/git-deploy. Backwards-compatible CLI; servers only need bash/git.
